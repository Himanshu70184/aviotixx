...
const FALLBACK_BLOGS = [
  { _id: 'fb1', image: 'https://images.unsplash.com/photo-1748951447152-5a9992576e6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYSUyMHRhaiUyMG1haGFsJTIwdHJhdmVsfGVufDF8fHx8MTc3MTQ0NzQ0NXww&ixlib=rb-4.1.0&q=80&w=1080', title: 'Best Time to Visit India', excerpt: 'Discover the ideal months to book your flight to India for perfect weather and festivals.', readTime: '5 min read' },
  { _id: 'fb2', image: 'https://images.unsplash.com/photo-1635247055412-6007edbd9af7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYSUyMGhvbGklMjBmZXN0aXZhbCUyMGNvbG9yZnVsfGVufDF8fHx8MTc3MTQ0NzQ0NXww&ixlib=rb-4.1.0&q=80&w=1080', title: 'Top 10 Indian Festivals', excerpt: 'Plan your trip around these colorful celebrations for an unforgettable experience.', readTime: '7 min read' },
  { _id: 'fb3', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYW4lMjBmb29kJTIwc3RyZWV0JTIwbWFya2V0fGVufDF8fHx8MTc3MTQ0NzQ0Nnww&ixlib=rb-4.1.0&q=80&w=1080', title: 'Must-Try Indian Cuisines', excerpt: 'From street food to fine dining - a foodie\'s guide to culinary adventures in India.', readTime: '6 min read' },
];

const FALLBACK_TESTIMONIALS = [
  { _id: 'ft1', customerPhoto: 'https://images.unsplash.com/photo-1762341120638-b5b9358ef571?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMHdvbWFufGVufDF8fHx8MTc3MTQxMjM0NXww&ixlib=rb-4.1.0&q=80&w=1080', name: 'Priya Sharma', location: 'New York, NY', review: 'Saved $427 on family tickets! The phone agent found deals I couldn\'t find anywhere else online.', rating: 5, routeLabel: 'NYC → Mumbai', badge: 'VERIFIED' },
  { _id: 'ft2', customerPhoto: 'https://images.unsplash.com/photo-1598268012815-ae21095df31b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMG1hbnxlbnwxfHx8fDE3NzE0MjQzMDF8MA&ixlib=rb-4.1.0&q=80&w=1080', name: 'Rajesh Patel', location: 'San Francisco, CA', review: 'Got a direct flight to Mumbai for $699 when everyone else wanted $1,200+. Phone deals are real!', rating: 5, routeLabel: 'SFO → Mumbai', badge: 'VERIFIED' },
  { _id: 'ft3', customerPhoto: 'https://images.unsplash.com/photo-1650113794972-56031832c0db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoYXBweSUyMHRyYXZlbGVyJTIwYWlycG9ydHxlbnwxfHx8fDE3NzE0NDA1MDF8MA&ixlib=rb-4.1.0&q=80&w=1080', name: 'Sarah Johnson', location: 'Chicago, IL', review: 'Saved over $500 on business class. Agent helped me get better seats. Used them 3 times!', rating: 5, routeLabel: 'ORD → Delhi', badge: 'Repeat Customer' },
];

const FALLBACK_FAQS = [
  { _id: 'ff1', question: 'Why are phone prices cheaper?', answer: 'We have exclusive airline contracts giving us access to unpublished consolidator fares only available by phone. Our agents can bundle services and apply multiple discounts that online systems can\'t process.' },
  { _id: 'ff2', question: 'Is it safe to book over the phone?', answer: 'Absolutely! We use secure payment processing and never store card details. We\'re BBB A+ accredited, IATA certified, and have 25+ years of trusted experience serving travelers.' },
  { _id: 'ff3', question: 'How quickly can I book?', answer: 'Most calls take just 5-10 minutes! You\'ll receive your confirmation email immediately after booking, and our agents handle all the details for you.' },
];
...
export function LandingPage() {
  ...
  // Live CMS data from backend
  const { blogs: cmsBlogs, testimonials: cmsTestimonials, faqs: cmsFaqs, contact } = useCMSContent();
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {(cmsTestimonials.length > 0 ? cmsTestimonials : FALLBACK_TESTIMONIALS).map((t) => (
              <div key={t._id} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex items-center gap-1 bg-emerald-50 px-2 py-0.5 rounded-full">
                        ...
                        <span className="text-[10px] font-semibold text-emerald-700">{t.badge || 'VERIFIED'}</span>
                      </div>
                    </div>
                ...
                <p className="text-xs text-gray-700 leading-relaxed mb-2">"{t.review}"</p>
                {t.routeLabel && (
                  <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                    <span className="text-[10px] text-gray-400">{t.routeLabel}</span>
                  </div>
                )}
              </div>
            ))}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {(cmsBlogs.length > 0 ? cmsBlogs : FALLBACK_BLOGS).map((blog, i) => (
              <div key={blog._id || i} data-animate="slideUp" data-delay={String(i + 1)}>
                <BlogCard
                  image={blog.image}
                  title={blog.title}
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-2">
            {(cmsFaqs.length > 0 ? cmsFaqs : FALLBACK_FAQS).map((faq) => (
              <div key={faq._id || faq.question} className="bg-white rounded-lg p-3 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <FAQItem
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              <img src={logo} alt="Aviotixx" className="h-9 mb-4 brightness-0 invert opacity-90" />
