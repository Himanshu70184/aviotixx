          ...
          <div className="relative mb-8">
            ...
            <div className="flex items-center justify-between relative mb-6">
              ...
              <div className="flex-1 relative h-24">
                {/* Dashed line */}
                <div className="absolute top-1/2 left-0 right-0 h-0.5 border-t-2 border-dashed border-gray-300"></div>
                ...
                >
                  <div className="relative">
                    <Plane className="w-8 h-8 text-[#FF6B35] transform rotate-45" />
                    {/* Plane trail */}
                    <div className="absolute top-1/2 right-full w-12 h-0.5 bg-gradient-to-r from-[#FF6B35]/0 to-[#FF6B35]/50"></div>
                  </div>
                </div>

                {/* Floating clouds */}
                <div className="absolute top-2 left-1/4 opacity-30 animate-float">
                  <div className="text-2xl">☁️</div>
                </div>
                <div className="absolute top-12 left-2/3 opacity-20 animate-float" style={{ animationDelay: '1s' }}>
